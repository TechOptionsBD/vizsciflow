...
def demo_service(context, *args, **kwargs):
	blast_to_raw = path.join(thispath, 'quote-alignment', 'scripts', 'blast_to_raw.py')
	...
	cmdargs = [arguments['blast'], "--localdups --qbed=" + arguments['qbed'], "--sbed="+ arguments['sbed'], "--tandem_Nmax=" + arguments['tandem_Nmax'], "--cscore=" + arguments['cscore'], ">", out]
