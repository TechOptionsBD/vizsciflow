...
-- Started on 2025-01-28 16:22:41 UTC
...
2	46	2025-01-25 01:35:42.440151	2025-01-25 16:46:19.488379	Check Quality and Sequence Alignment (No Parameter)	Check quality of a fasta/fastq file and align with a reference Genome. Constant paths are used for fasta/fastq file and reference genome.	data = '/public/MiSeq_SOP/F3D3_S191_L001_R1_001.fastq'\r\nref = '/public/genomes/Chr1.cdna'\r\nhtml,zip = fastqc.CheckQuality(data)\r\ndata = bwa.Align(ref, data)\r\nreturn data	t	f	0
...
36	46	2025-01-28 02:11:10.38026	2025-01-28 07:47:16.217136	Bio Marker Classifier Workflow	This is a small workflow to classify bio marker	fasta = '/public/MiSeq_SOP/F3D3_S191_L001_R1_001.fastq'\r\nfa_markers = bio.BioMarkers(fasta)\r\n\r\nimgs = '/public/bioml/images'\r\nimg_markers = img.BioMarkers(imgs)\r\n\r\nmodel = ml.ClassifyBioMarker(fa_markers, img_markers)\r\nreturn model	t	f	0
37	46	2025-01-28 10:59:23.026267	2025-01-28 10:59:48.749198	Bio Marker Predictor Workflow	A workflow to predict biomarkers using a model	fasta = '/public/MiSeq_SOP/F3D149_S215_L001_R1_001.fastq'\r\nfa_markers = bio.BioMarkers(fasta)\r\n\r\nimgs = '/public/bioml/images'\r\nimg_markers = img.BioMarkers(imgs)\r\n\r\nmodel = '/users/testuser/temp/67189135-a7f7-42ae-9388-b362e05484cc/b45163f9-173b-4b49-80d1-a12efcc62592/d3dbaa03-c89d-4ddb-a372-e8b42160cc70.pkl'\r\ndata = ml.PredictBioMarker(fa_markers,img_markers,model)\r\nreturn data	t	f	0
...
SELECT pg_catalog.setval('public.workflows_id_seq', 37, true);
...
-- Completed on 2025-01-28 16:22:46 UTC
