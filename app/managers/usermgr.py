...
from ..elasticutil import ElasticRoleItem, ElasticUserItem
...
class ElasticUser():
    ...
    def create_user(**kwargs):
        return ElasticUserItem.Create(**kwargs)

    @staticmethod
    def first(**kwargs):
         return ElasticUserItem.first(level='users', **kwargs)
    ...
    @staticmethod
    def insert_roles():
        return ElasticRoleItem.insert_roles()
